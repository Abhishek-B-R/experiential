...
the event says as a :class:`~exp.common.traces.ingest.vendor_observations.VendorObservation`, and
hands canonical trace construction to :mod:`exp.common.traces.ingest.vendor_trace` with strict tool
...
from exp.common.traces.ingest.vendor_trace import approved_extensions, build_vendor_traces
