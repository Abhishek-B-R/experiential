...
class _PendingWrite:
    ...
    prepare: Callable[[], AbstractContextManager[Callable[[sqlite3.Connection], object]]] | None = (
        None
    )
...
def _prepared_chain_write(
    ...
    with core.prepare_chain_authority(authorization, operation) as proof:
...
class GroupCommitAttemptLedger:
                        ...
                        for pending in batch:
                            try:
                                apply = (
                                    ...
                                    else preparations.enter_context(pending.prepare())
                                )
    ...
    def _enqueue_chain(
        ...
        return self._enqueue(
            ...
            prepare=lambda: _prepared_chain_write(self.core, authorization, operation, apply),
        )
    ...
    def _enqueue(
        ...
        *,
        prepare: Callable[[], AbstractContextManager[Callable[[sqlite3.Connection], object]]]
        | None = None,
