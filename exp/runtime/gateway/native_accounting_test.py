...
def test_opened_disconnect_estimates_cache_reads_from_the_organizations_settled_share() -> None:
    """The org's own settled cached fraction on the rung fills the unreported cache-read leg."""
    registry, ledger, entry = _registry()
    started = _start(registry, ordinal=0)
