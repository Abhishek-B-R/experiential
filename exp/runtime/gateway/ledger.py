...
class SQLiteAttemptLedger:
    ...
    def prepare_chain_authority(
        ...
        """Read and classify local policy before the caller opens a write transaction."""
        with (
    ...
    def accept_request(self, *, authorization: AuthorizationSnapshot) -> None:
        ...
        """
        with (
            self.prepare_chain_authority(authorization, "accept") as proof,
    ...
    def start_attempt(
        ...
        *,
        ...
        """
        with (
            self.prepare_chain_authority(snapshot.authorization, "reserve") as proof,
            self._transaction() as connection,
        ):
